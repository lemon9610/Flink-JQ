...
public class JQSetRedisSink extends RichSinkFunction<Tuple2<String, String>> {
    ...
    public JQSetRedisSink(Set<HostAndPort> hostAndPorts, String password) {
